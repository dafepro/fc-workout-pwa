...
| 2026-08-26 | 4Q      | Current focused-drag slice       | Suppresses edit controls, badges, selection chrome, and open action menus for the full item-movement gesture while retaining only the room, moving item, and trash target                         | Overlay and adapter interaction regressions                                                                                                    | Mobile visual focus; controls return cleanly after move                                  |
