...
| 2026-08-26 | 4L      | pending                          | Gives the current avatar pointer priority over an editable stamp underneath it, then immediately restores stamp editing for subsequent gestures                                                   | Same-position avatar/stamp routing regression; shared lounge interaction tests                                                                 | Drag avatar over a large stamp; select the stamp from its exposed edge                   |
