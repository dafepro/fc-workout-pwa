...
| Persistent stamps              | Yes                      | Zoomigo-authorized durable item          | Move/scale/tilt |
...
| 2026-08-26 | 4D      | Current orientation slice        | Adds owner-only `−15° / 0° / +15°` rotation, persisted rendering, bounded authorization, and responsive edit controls; records the atomic replacement boundary | Canvas authorizer contract and 360-test suite; Zoomigo unit/component/authenticated WebSocket tests; static/build/dev gates pending            | Rotation controls and persistence at 320px; replacement contract    |
