...
| CI release gate          | Implemented                         | Static checks and builds run before local Docker API/browser E2E and the VM smoke suite; only a passing commit publishes an immutable image.                                                                                                       |
