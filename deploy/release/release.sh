...
(
	...
	REWARD_MAILER_MODE=${REWARD_MAILER_MODE:-sink}
	REWARD_EMAIL_FROM=${REWARD_EMAIL_FROM:-ZoomiGo Rewards <rewards@example.invalid>}
	REWARD_EMAIL_BASE_URL=${REWARD_EMAIL_BASE_URL:-${PLAYER_LOGIN_URL%/login}}
