...
SERVICE_TEMPLATE="$DEPLOY_DIRECTORY/systemd/zoomigo-backup.service"
TIMER_TEMPLATE="$DEPLOY_DIRECTORY/systemd/zoomigo-backup.timer"
...
install -m 0644 "$temporary_service" /etc/systemd/system/zoomigo-backup.service
install -m 0644 "$TIMER_TEMPLATE" /etc/systemd/system/zoomigo-backup.timer
