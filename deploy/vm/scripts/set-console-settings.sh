...
allowed_key() {
	case "$1" in
		STAFF_SECRET_KEY|PLAYER_LOGIN_URL|STAFF_SETUP_URL|PRODUCTION_DATA_APPROVED|REWARD_MAILER_MODE|REWARD_EMAIL_FROM|REWARD_EMAIL_BASE_URL|RESEND_API_KEY) return 0 ;;
		*) return 1 ;;
	esac
}
