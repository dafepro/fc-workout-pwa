export const copy = {
  ...
  prizes: {
    ...
    headerArtAlt: "Zoomi celebrating beside a prize box",
    back: "Back to Today",
    help: "How Prize Boxes work",
    closeHelp: "Close help",
    helpItems: [
      "One free sealed box is available each day.",
      "Coach-plan participation can earn extra boxes.",
      "Claiming never reveals or rerolls what is inside.",
      "Open boxes whenever you want.",
      "Opened items stay in your private collection.",
      "Owned items can be used in Team Lounge or Avatar Studio.",
    ],
    ...
    openGroup: (source: string, count: number) =>
      `Open ${source}, ${count} waiting`,
    collection: "Your collection",
    collectionDetail: "Browse what you own and where each item can be used.",
    collectionLoading: "Loading your collection…",
    collectionLoadFailed:
      "Your collection could not be loaded. Your boxes are still safe.",
    retryCollection: "Retry collection",
    emptyCollection: "Your first opened prize will appear here.",
    collectionView: "Prize view",
    collectionTab: "Collection",
    historyTab: "History",
    collectionFilter: "Prize category",
    allFilter: "All",
    loungeFilter: "Team Lounge",
    avatarFilter: "Avatar",
    newItem: "New",
    viewItem: (label: string) => `View ${label}`,
    markViewedFailed:
      "We could not mark this prize as viewed. It is still in your collection.",
    revealEyebrow: "You found",
    close: "Close",
    closeDetail: "Close prize detail",
    ...
    sources: {
      ...
      staff_grant: "Development grant",
    },
    historySources: {
      daily_check_in: "From daily box",
      plan_participation_3: "From 3-day plan box",
      plan_completion_7: "From 7-day plan box",
      included: "Included with your collection",
      staff_grant: "From the development catalog",
    },
    rarities: {
      common: "Common",
      uncommon: "Uncommon",
  ...
  teamLounge: {
    ...
    actions: {
      ...
      chooseChatPack: (pack: string) => `Choose a ${pack} message`,
      chatSettings: "Quick-message pack settings",
      chooseChatPacks: "Choose chat packs",
  ...
  avatar: {
    ...
    options: {
      kit: {
        ...
        sunset: "Split kit",
        classic: "Sash kit",
        checkers: "Checkerboard kit",
        starburst: "Starburst kit",
        nebulaArmor: "Nebula armor kit",
        phoenixFlight: "Phoenix flight kit",
      },
      background: {
        solid: "Solid",
      },
      ...
      head: {
        ...
        fox: "Scout the fox",
        owl: "Night owl",
        panda: "Piper the panda",
        lion: "Leo the lion",
        prismDragon: "Prism dragon",
        moonAxolotl: "Moonlit axolotl",
      ...
      hat: {
        ...
        crystalAntlers: "Crystal antler crown",
      },
      eyewear: {
        none: "No glasses",
        aviators: "Aviators",
        ...
        stars: "Star glasses",
        lightning: "Lightning glasses",
        hearts: "Heart glasses",
        hologramVisor: "Hologram visor",
        clockwork: "Clockwork goggles",
      },
      effect: {
        none: "No effect",
        orbit: "Orbit effect",
