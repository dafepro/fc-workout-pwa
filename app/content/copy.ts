export const copy = {
  ...
  avatar: {
    ...
    options: {
      kit: {
        violet: "Violet strike kit",
        ocean: "Ocean sprint kit",
        coral: "Coral charge kit",
        lime: "Lime lightning kit",
        midnight: "Midnight hoops kit",
        keeper: "Goalkeeper kit",
        sunset: "Sunset split kit",
        classic: "Classic white kit",
      },
      background: {
        solid: "Solid",
      },
