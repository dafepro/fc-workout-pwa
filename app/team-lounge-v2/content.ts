...
export const teamLoungeV2Copy = {
  ...
  placementTray: {
    loading: "Loading your lounge items…",
    error: "Your lounge items could not load. Close the picker and try again.",
    sharedOnly: "Join the shared team room to leave a weekly item.",
    ready: (count: number) =>
      `${count} ${count === 1 ? "placement" : "placements"} ready`,
    earn: "Check in to earn a placement",
    used: "All weekly placements used",
    placing: "Adding your item…",
    place: "Tap anywhere in the lounge to place it.",
    locked: "Earlier items are locked. Today’s items can still be adjusted.",
    explanation: "Each workout or rest check-in adds one for this week.",
    empty: "No stamps are available to place yet.",
    emptyProps: "Open Prize Boxes to find your first lounge prop.",
  },
