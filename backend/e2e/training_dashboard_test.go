...
func TestTrainingDashboardOwnsAssignmentCatalogAndCompletion(t *testing.T) {
	...
	for _, expected := range []string{`"weeklyGoal":3`, `"weeklySessions":2`, `"momentumScore":8`, `"currentCheckInStreak":2`, `"activityDefinitionId":"hill-sprints"`, `"catalogKey":"hill_sprints_8x6"`, `"completed":false`, `"streakComparison"`} {
