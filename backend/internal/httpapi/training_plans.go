...
func (service *service) trainingPlanRepository(w http.ResponseWriter, r *http.Request) (TrainingPlanRepository, bool) {
	repository, ok := service.staffStore.(TrainingPlanRepository)
	if !ok {
...
func (service *service) listTrainingPlans(w http.ResponseWriter, r *http.Request) {
	...
	repository, ok := service.trainingPlanRepository(w, r)
	if !ok {
		return
	}
	plans, err := repository.ListTrainingPlans(r.Context(), teamID)
...
func (service *service) publishTrainingPlan(w http.ResponseWriter, r *http.Request) {
	...
	plan, err := repository.PublishTrainingPlan(r.Context(), teamID, store.TrainingPlanInput{
...
func (service *service) cancelTrainingPlan(w http.ResponseWriter, r *http.Request) {
	...
	plan, err := repository.CancelTrainingPlan(r.Context(), teamID, planID)
...
func (service *service) rescheduleTrainingPlan(w http.ResponseWriter, r *http.Request) {
	...
	plan, err := repository.RescheduleTrainingPlan(r.Context(), teamID, planID, store.TrainingPlanInput{
