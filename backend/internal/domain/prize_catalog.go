...
var prizeCatalog = []PrizeItem{
	...
	{ID: "lounge-prop-duck-pond", Kind: PrizeLoungeProp, Slot: "prop", AssetID: "duck-pond", Label: "Duck pond", CatalogVersion: 1, Rarity: PrizeRare, Destination: PrizeDestinationTeamLounge},
	{ID: "lounge-prop-hammock", Kind: PrizeLoungeProp, Slot: "prop", AssetID: "hammock", Label: "Hammock", CatalogVersion: 1, Rarity: PrizeUncommon, Destination: PrizeDestinationTeamLounge},
	{ID: "lounge-prop-robot-goalie", Kind: PrizeLoungeProp, Slot: "prop", AssetID: "robot-goalie", Label: "Robot goalie", CatalogVersion: 1, Rarity: PrizeEpic, Destination: PrizeDestinationTeamLounge},
	{ID: "lounge-prop-pinball-bumper", Kind: PrizeLoungeProp, Slot: "prop", AssetID: "pinball-bumper", Label: "Pinball bumper", CatalogVersion: 1, Rarity: PrizeRare, Destination: PrizeDestinationTeamLounge},
