...
var logicalTables = []logicalTable{
	...
	},
	{
		...
		Fields: []logicalField{
			...
			nullable(textField("reservation_id")),
			nullable(blobField("idempotency_key_hash")),
			nullable(blobField("request_hash")),
			nullable(textField("definition_id")),
			nullable(realField("position_x")),
			nullable(realField("position_y")),
			nullable(textField("placement_state")),
			nullable(textField("entity_id")),
			nullable(textField("reserved_at")),
			nullable(textField("placed_at")),
		},
	},
	{
		Name:    "accounts",
